...
specialized language  that lives inside  a more general  language.  In
our case, it  means that \pyblio provides a  set of classes, functions
and constructs  that are  highly specialized to  make the  business of
writing the  citation code easy.  The  beauty of the idea  is that, in
case of a missing feature in the  DSL, you still have all the power of
python at your hand.
...
blown  HTML web  page  for  instance.  Howeve,  the  specific part  of
putting your citations in context is comparatively easy.
...
value wherea definition can be invalid.
